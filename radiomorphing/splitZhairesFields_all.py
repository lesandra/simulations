...
#injh=3000. # m # just nicolas



for i in range(0, len(z)):
    z[i]= 100000. -z[i] # inverse by subtracting from max height of 100km, ATTENTION: ground has to be at altitude:0m in the simulations, otherwise to be included in here and as well in the scaling.
